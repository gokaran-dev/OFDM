...
module ofdm_transreceiver_tb (

);
  wire [16-1:0] imaginary_fft_input_net;
  wire [1-1:0] gateway_out2_net;
  wire [1-1:0] random_binary_stream_net;
  wire clk_net;
  wire [16-1:0] real_fft_input_net;
  wire [23-1:0] real_output_net;
  wire [23-1:0] imaginary_output_net;
  xlclk #(
    .clk_period(10)
  )
  clk_driver (
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(1),
    .inputFile("ofdm_transreceiver_random_binary_stream.dat"),
    .periodMultiplier(1)
  )
  random_binary_stream_driver (
    .clk(clk_net),
    .o(random_binary_stream_net)
  );
  xltbsource #(
    .o_arith(`xlSigned),
    .o_bin_pt(15),
    .o_width(16),
    .inputFile("ofdm_transreceiver_real_fft_input.dat"),
    .periodMultiplier(4)
  )
  real_fft_input_driver (
    .clk(clk_net),
    .o(real_fft_input_net)
  );
  xltbsource #(
    .o_arith(`xlSigned),
    .o_bin_pt(15),
    .o_width(16),
    .inputFile("ofdm_transreceiver_imaginary_fft_input.dat"),
    .periodMultiplier(4)
  )
  imaginary_fft_input_driver (
    .clk(clk_net),
    .o(imaginary_fft_input_net)
  );
  xltbsink #(
    .i_arith(`xlSigned),
    .i_bin_pt(15),
    .i_width(23),
    .inputFile("ofdm_transreceiver_real_output.dat"),
    .periodMultiplier(4)
  )
  real_output_load (
    .i(real_output_net),
  ...
  xltbsink #(
    ...
    .i_bin_pt(15),
    .i_width(23),
    .inputFile("ofdm_transreceiver_imaginary_output.dat"),
    .periodMultiplier(4)
  )
  imaginary_output_load (
    .i(imaginary_output_net),
    .clk(clk_net)
  );
  xltbsink #(
    .i_arith(`xlUnsigned),
    .i_bin_pt(0),
    .i_width(1),
    .inputFile("ofdm_transreceiver_gateway_out2.dat"),
    .periodMultiplier(1)
  )
  gateway_out2_load (
    .i(gateway_out2_net),
  ...
  ofdm_transreceiver_bd_wrapper sysgen_dut (
    .random_binary_stream(random_binary_stream_net),
    .real_fft_input(real_fft_input_net),
    .imaginary_fft_input(imaginary_fft_input_net),
    .clk(clk_net),
    .real_output(real_output_net),
    .imaginary_output(imaginary_output_net),
