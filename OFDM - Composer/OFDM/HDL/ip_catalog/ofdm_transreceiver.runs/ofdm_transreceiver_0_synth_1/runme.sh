...
HD_PWD='C:/Users/Gokaraan/Documents/Composer/OFDM/HDL/ip_catalog/ofdm_transreceiver.runs/ofdm_transreceiver_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ofdm_transreceiver_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ofdm_transreceiver_0.tcl
